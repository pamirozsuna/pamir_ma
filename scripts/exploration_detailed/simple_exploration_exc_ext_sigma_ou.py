...
total_runs = len(input_exc_ext)*len(input_sigma_ou)
...
np.save("gbc_exc_ext_sigma_ou1.npy", total_gbc_model)    
np.save("parameters_exc_ext_sigma_ou1.npy", total_parameters)     
