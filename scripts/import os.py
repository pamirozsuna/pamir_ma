...
#input_exc_ext = np.linspace(0.5, 1.0, 10)
#input_c_ii = np.linspace(0, 2, 10)
#input_c_ie = np.linspace(8, 11, 10)
#input_c_ei = np.linspace(8, 11, 10)

input_exc_ext = [0.5]
input_c_ii = [0.2222222222222222]
input_c_ie = [8.666666666666666]
input_c_ei = [10.0]
        ...
        for index_input_c_ie in range(len(input_c_ie)):
            for index_input_c_ei in range(len(input_c_ei)):
                #for index_input_K_gl in range(len(input_K_gl)):
                    ...
                    wc.params['c_inhexc'] = input_c_ie[index_input_c_ie]
                    wc.params['c_inhinh'] = input_c_ii[index_input_c_ii]
                    wc.params['K_gl'] = 1.84
                    wc.params['sigma_ou'] = 4.28e-05
                    input_parameters.append(wc.params['exc_ext'])
                    input_parameters.append(wc.params['c_excinh'])
...
np.save("gbc.npy", total_gbc_model)    
np.save("parameters.npy", total_parameters)     
